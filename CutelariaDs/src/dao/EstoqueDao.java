...
public class EstoqueDao {
     ...
     try(PreparedStatement stm = con.prepareStatement(sql)){
        ...
        Connection con = ConexaoBD.getConectarBD(); 
        String sql= "UPDATE estoque SET  quantidade_es=?,id_produto=? WHERE id_es=?"; 
        try(PreparedStatement stm= con.prepareStatement(sql)){
    ...
    public void deletar(Estoque e){
        ...
        int opcao = JOptionPane.showConfirmDialog(null,"Deseja excluir o produto"+e.getId_es()+"?", "Exclusão", JOptionPane.YES_NO_OPTION);//janela de confirmação
